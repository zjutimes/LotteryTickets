package com.betterzw.lotterytickets.network;

import android.support.annotation.NonNull;
import android.support.annotation.VisibleForTesting;

import com.betterzw.lotterytickets.LotteryApp;
...
public class OkHttpConnectionFactory {
    ...
    @VisibleForTesting
    @NonNull
    public static final Cache NET_CACHE = new Cache(new File(LotteryApp.getInstance().getCacheDir(),
            CACHE_DIR_NAME), NET_CACHE_SIZE);
    private static final long SAVED_PAGE_CACHE_SIZE = NET_CACHE_SIZE * 1024;
    @NonNull public static final Cache SAVE_CACHE = new Cache(new File(LotteryApp.getInstance().getFilesDir(),
